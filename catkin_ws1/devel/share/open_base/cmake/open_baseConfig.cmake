...
if("TRUE" STREQUAL "TRUE")
  set(open_base_SOURCE_PREFIX /home/jinsu_park/catkin_ws/src/OpenBase/ROS/open_base)
  set(open_base_DEVEL_PREFIX /home/jinsu_park/catkin_ws/devel)
  ...
  set(open_base_INSTALL_PREFIX /home/jinsu_park/catkin_ws/install)
...
if(NOT "/home/jinsu_park/catkin_ws/devel/include;/usr/include/eigen3;/opt/ros/melodic/share/orocos_kdl/cmake/../../../include " STREQUAL " ")
  set(open_base_INCLUDE_DIRS "")
  set(_include_dirs "/home/jinsu_park/catkin_ws/devel/include;/usr/include/eigen3;/opt/ros/melodic/share/orocos_kdl/cmake/../../../include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'open_base' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jinsu_park/catkin_ws/src/OpenBase/ROS/open_base/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT open_base_NUM_DUMMY_TARGETS)
      set(open_base_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::open_base::wrapped-linker-option${open_base_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR open_base_NUM_DUMMY_TARGETS "${open_base_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::open_base::wrapped-linker-option${open_base_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND open_base_LIBRARIES "${interface_target_name}")
...
set(depends "roscpp;sensor_msgs;nav_msgs;tf;message_runtime;kdl_parser")
