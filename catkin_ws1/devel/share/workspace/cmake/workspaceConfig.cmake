...
if("TRUE" STREQUAL "TRUE")
  set(workspace_SOURCE_PREFIX /home/jinsu_park/catkin_ws/src/workspace)
  set(workspace_DEVEL_PREFIX /home/jinsu_park/catkin_ws/devel)
  ...
  set(workspace_INSTALL_PREFIX /home/jinsu_park/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'workspace' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'workspace' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jinsu_park/catkin_ws/src/workspace/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT workspace_NUM_DUMMY_TARGETS)
      set(workspace_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::workspace::wrapped-linker-option${workspace_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR workspace_NUM_DUMMY_TARGETS "${workspace_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::workspace::wrapped-linker-option${workspace_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND workspace_LIBRARIES "${interface_target_name}")
...
set(depends "trajectory_msgs;moveit_core;moveit_ros_planning_interface;moveit_visual_tools")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${workspace_dep}_FOUND)
      find_package(${workspace_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${workspace_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
